...
public class GuarantyRecord extends UpdatableRecordImpl<GuarantyRecord> implements Record9<Integer, String, Integer, Integer, String, Integer, Integer, Integer, String> {

    private static final long serialVersionUID = 2094164768;
     ...
     */
    @Override
    public Row9<Integer, String, Integer, Integer, String, Integer, Integer, Integer, String> fieldsRow() {
     ...
     */
    @Override
    public Row9<Integer, String, Integer, Integer, String, Integer, Integer, Integer, String> valuesRow() {
     ...
     */
    @Override
    public GuarantyRecord values(Integer value1, String value2, Integer value3, Integer value4, String value5, Integer value6, Integer value7, Integer value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GuarantyRecord(Integer guarantyid, String accountnum, Integer state, Integer scopeofright, String ownername, Integer reportid, Integer type, Integer evaluatevalue, String name) {
        super(Guaranty.GUARANTY);
