...
public class CreditRecord extends UpdatableRecordImpl<CreditRecord> implements Record5<String, Integer, Integer, Byte, Byte> {

    private static final long serialVersionUID = 1036474995;
    ...
    /**
     * Setter for <code>bcinvest.Credit.Lock</code>.
     */
    ...
    /**
     * Getter for <code>bcinvest.Credit.Lock</code>.
     */
    public Byte getLock() {
        return (Byte) get(4);
    }
     ...
     */
    @Override
    public Row5<String, Integer, Integer, Byte, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row5<String, Integer, Integer, Byte, Byte> valuesRow() {
     ...
     */
    @Override
    public CreditRecord value5(Byte value) {
        setLock(value);
        return this;
    }
     ...
     */
    @Override
    public CreditRecord values(String value1, Integer value2, Integer value3, Byte value4, Byte value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CreditRecord(String accountnum, Integer guarantyid, Integer reportid, Byte type, Byte lock) {
        super(Credit.CREDIT);
