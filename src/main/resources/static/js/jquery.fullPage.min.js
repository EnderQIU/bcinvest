...
} function na(a) { if (c.recordHistory) location.hash = a; else if (C || P) history.replaceState(void 0, void 0, "#" + a); else { var b = window.location.href.split("#")[0]; window.location.replace(b + "#" + a) } } function nl() { $(".withLarge").toggleClass("large"); } function D(a) { a = a.replace("/", "-").replace("#", ""); var t = $("body")[0].className; if (t.indexOf("fp-viewing-") < 0 || t.indexOf("fp-viewing-0") >= 0 || a.indexOf("0") == 0) nl(); b("body")[0].className = b("body")[0].className.replace(/\b\s?fp-viewing-[^\s]+\b/g, ""); b("body").addClass("fp-viewing-" + a) } function za() {
    var a =
